...
- [ ] Etapa C: formulário de funcionário com campos PH (TIN/SSS/PhilHealth/Pag-IBIG)
- [ ] Etapa C: PhSeparationPanel na UI de separations
- [ ] Etapa C: download dos 5 filings pela UI com checksum
- [ ] Etapa C: elegibilidade NCR/overtime no formulário de piloto /ph (consentimento ph-pilot-2026-09-23, novas colunas em pilot_requests)
- [ ] Verificação: tsgo + vitest + verify-bundle-packs.mjs
