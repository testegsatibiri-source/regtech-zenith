...
const phRules: ComplianceRule[] = [
  ...
  // H22 Phase A — separation rules are scored per employee for compliance readiness.
  {
    ...
    evaluate: (emp) => {
      ...
      return {
        passed: true,
        message: "Employee-level rule reserved; separation workflow validates NTE + decision notices",
      };
    },
  },
  {
    ...
    evaluate: (emp) => {
      return {
        passed: true,
        message: "Employee-level rule reserved; final pay deadline is enforced by the separation workflow",
      };
    },
  },
  {
    ...
    evaluate: (emp) => {
      return {
        passed: true,
        message: "Employee-level rule reserved; COE document is generated by the separation workflow",
      };
    },
  },
];
