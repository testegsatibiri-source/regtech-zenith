...
const CATALOG: Record<CapabilityId, CapabilityDescriptor> = {
  search:       { id: "search",       version: "1.0.0", summary: "Semantic search over the Knowledge Store.",         inputSchema: { text: "string" }, outputSchema: { hits: "SearchHit[]" } },
  plan:         { id: "plan",         version: "1.0.0", summary: "Produce an implementation plan for an objective.",  inputSchema: { objective: "string" }, outputSchema: { steps: "Step[]" } },
  review:       { id: "review",       version: "1.0.0", summary: "Review a diff or PR against Knowledge Base rules.", inputSchema: { diff: "string" }, outputSchema: { findings: "Finding[]" } },
  audit:        { id: "audit",        version: "1.0.0", summary: "Audit code/data against compliance rules.",         inputSchema: { scope: "string" }, outputSchema: { findings: "Finding[]" } },
  impact:       { id: "impact",       version: "1.0.0", summary: "Classify blast radius of changing a node.",         inputSchema: { nodeId: "string" }, outputSchema: { report: "ImpactReport" } },
  dependencies: { id: "dependencies", version: "1.0.0", summary: "List direct dependencies of a node.",               inputSchema: { nodeId: "string" }, outputSchema: { nodes: "GraphNode[]" } },
