  ...
  .handler(async ({ data, context }) => {
    ...
    const { error, data: row } = await supabase
      ...
      .insert({
        ...
        inputs_snapshot: result.inputsSnapshot as unknown as Json,
        calculation_trace: result.calculationTrace as unknown as Json,
        legal_basis_snapshot: result.legalBasis as unknown as Json,
        ...
        missing_inputs: result.completeness.missingInputs as unknown as Json,
        warnings: result.warnings as unknown as Json,
        compliance_violations: result.complianceViolations as unknown as Json,
