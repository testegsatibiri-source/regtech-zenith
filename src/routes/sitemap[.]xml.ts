    ...
    handlers: {
      GET: async () => {
        ...
        const entries: SitemapEntry[] = [
          ...
          { path: "/id/kebijakan-privasi", changefreq: "yearly", priority: "0.3" },
          { path: "/ph", changefreq: "weekly", priority: "0.9" },
          { path: "/ph/patakaran-sa-privacy", changefreq: "yearly", priority: "0.3" },
          ...packEntries,
