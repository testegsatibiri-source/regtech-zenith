            ...
            <Card>
              <CardContent className="space-y-6 pt-6 text-sm leading-relaxed text-muted-foreground">
                <section>
                  ...
                  <p>
                    Saat Anda mengajukan permohonan akses pilot, kami mengumpulkan nama lengkap,
                    email perusahaan, nama entitas/perusahaan, rentang jumlah karyawan, peran, serta
                    alamat IP (disimpan dalam bentuk hash satu arah). Kami tidak meminta NIK, NPWP,
                    nomor rekening bank, atau dokumen identitas lainnya melalui formulir ini.
                  </p>
                </section>
                <section>
                  <h2 className="mb-2 text-lg font-medium text-foreground">
                  ...
                  <p>
                    ...
                    memenuhi kewajiban audit internal. Kami tidak menjual atau membagikan data
                    pribadi kepada pihak ketiga untuk tujuan pemasaran.
                  </p>
                </section>
                <section>
                  <h2 className="mb-2 text-lg font-medium text-foreground">
                  ...
                  <p>
                    ...
                    27/2022). Anda dapat menarik persetujuan kapan saja dengan menghubungi kami,
                    dengan memahami bahwa penarikan tidak memengaruhi pemrosesan yang telah sah
                ...
                <section>
                  ...
                  <p>
                    Data pilot disimpan selama maksimal 24 bulan sejak pengajuan. Setelah masa
                    tersebut, data akan dihapus atau dianonimkan sesuai kebijakan retensi yang
                    berlaku.
                  </p>
                </section>
                <section>
                ...
                <section>
                  ...
                  <p>
                    Setiap perubahan material akan diberitahukan melalui email. Versi persetujuan
                    yang Anda terima saat pengajuan tetap tercatat bersama data Anda.
                  </p>
                </section>
              </CardContent>
            </Card>
