  ...
  head: () => ({
    meta: [
      { title: "Country Packs · UBoard Asia" },
      {
        name: "description",
        content:
          "Global compliance core and every installed country pack with tier, version, signature and live health.",
      },
    ],
  }),
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="flex flex-wrap items-center gap-4 p-6">
          ...
          <div className="min-w-[200px] flex-1">
            ...
            <p className="text-sm text-muted-foreground">
              Employees, payroll orchestration, compliance score, audit and API layer — jurisdiction
              agnostic.
            </p>
          </div>
                  ...
                  <CardContent className="p-5">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <div className="flex flex-col items-end gap-1">
                        <Badge variant={p.tier === "production" ? "default" : "outline"}>
                          {p.tier}
                        </Badge>
                        {p.signed && (
